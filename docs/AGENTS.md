...
Also bound here:
Harness Context Revision & Lineage Store, Workspace Instructions Lifecycle.

Bound here:
- file `docs/design-desktop-notifications-settings-return.md`
- file `docs/design-workspace-instructions.md`

[Showing 2 of 4 design element(s) bound here, 27 further line(s) dropped. Retrieve the rest with the adashi_design get_scope operation.]
