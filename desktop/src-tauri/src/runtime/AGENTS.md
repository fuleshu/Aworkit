...
Also bound here:
Model Call & Internal Agent Loop Orchestrator, Local State and Evidence Store.

Bound here:
- file `desktop/src-tauri/src/runtime/cancellation.rs`
- file `desktop/src-tauri/src/runtime/concurrency.rs`

[Showing 2 of 4 design element(s) bound here, 38 further line(s) dropped. Retrieve the rest with the adashi_design get_scope operation.]
