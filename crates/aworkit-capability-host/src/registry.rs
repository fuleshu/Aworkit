...
fn protocol_kind(kind: CapabilityKind) -> CapabilityKindV1 {
    match kind {
        ...
        CapabilityKind::Goal => CapabilityKindV1::Goal,
        CapabilityKind::AskUser => CapabilityKindV1::AskUser,
        CapabilityKind::Browse => CapabilityKindV1::Browse,
...
fn host_kind(kind: CapabilityKindV1) -> CapabilityKind {
    match kind {
        ...
        CapabilityKindV1::Goal => CapabilityKind::Goal,
        CapabilityKindV1::AskUser => CapabilityKind::AskUser,
        CapabilityKindV1::Browse => CapabilityKind::Browse,
